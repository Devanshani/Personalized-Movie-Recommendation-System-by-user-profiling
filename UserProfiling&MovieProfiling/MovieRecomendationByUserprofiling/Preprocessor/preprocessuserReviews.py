...
if __name__ == "__main__":
    ...
    cursor.execute("SELECT Comment,TblId FROM UserReviews")
    ...
    for row in cursor.fetchall():
        ...
        # cursor.execute("UPDATE UserReviews SET preprocessedReview ='" + str(preprocessed_final) + "' WHERE TblId =" + str(id))
        # cursor.commit()
