...
if __name__ == "__main__":
    ...
    cursor.execute("SELECT moviePlot,Tbl_ID FROM Movieinfos")
    ...
    for row in cursor.fetchall():
        ...
        # cursor.execute("UPDATE Movieinfos SET PreprocessedPlot ='" + str(preprocessed_final) + "' WHERE Tbl_ID =" + str(id))
        # cursor.commit()
