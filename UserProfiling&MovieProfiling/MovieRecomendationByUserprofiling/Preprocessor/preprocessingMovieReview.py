...
if __name__ == "__main__":
    ...
    cursor.execute("SELECT quote,ReviewId FROM ReviewsNew")
    ...
    for row in cursor.fetchall():
        ...
        # tweet="#Whoops cooooool gr8! \ud83d\ude02"

        # usermention_tweet = re.sub('@[^\s]+', 'USER_MENTION', tweet).lower()
        ...
        # print(additional_white_less_tweet)
        # remove urls
        ...
        # stop_less_tweet = pattern.sub('', http_less_tweet)
        # print(stop_less_tweet)
        # remove email
        ...
        # cursor.execute("UPDATE ReviewsNew SET preprocessedReview ='" + str(preprocessed_final) + "' WHERE ReviewId =" + str(id))
        # cursor.commit()
